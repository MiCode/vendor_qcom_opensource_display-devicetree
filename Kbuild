...
dtbo-$(CONFIG_ARCH_CANOE) += display/canoe-sde.dtbo \
		display/popsicle-sde-display-overlay.dtbo \
		display/nezha-sde-display-overlay.dtbo \
		display/pudding-sde-display-mtp-overlay.dtbo \
		display/myron-sde-display-mtp-overlay.dtbo \
		display/pandora-sde-display-mtp-overlay.dtbo \
