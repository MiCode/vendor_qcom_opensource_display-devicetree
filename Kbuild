...
dtbo-$(CONFIG_ARCH_SUN) += display/sun-sde.dtbo \
		...
		display/annibale-sde-display-mtp-overlay.dtbo \
		display/dada-sde-display-mtp-overlay.dtbo \
		display/xuanyuan-sde-display-mtp-overlay.dtbo \
		display/bixi-sde-display-mtp-overlay.dtbo \
		display/piano-sde-display-mtp-overlay.dtbo \
...
dtbo-$(CONFIG_ARCH_TUNA) += display/tuna-sde.dtbo \
		display/onyx-sde-display-mtp-overlay.dtbo \
                display/luming-sde-display-mtp-overlay.dtbo \
		display/yupei-sde-display-mtp-overlay.dtbo \
